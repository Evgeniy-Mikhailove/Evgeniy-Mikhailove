<p align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.herokuapp.com?font=Bitcount+Single&weight=500&size=30&duration=4000&pause=1000&color=FF8612&center=true&vCenter=true&width=500&height=70&lines=PROMPT+ENGINEERING++%F0%9F%A7%A0%2B%F0%9F%A4%96%3D%F0%9F%98%8E" alt="Typing SVG" />
  </a>
</p>
...
|---------|-------------|---|
| [multi-model-router](https://github.com/Evgeniy-Mikhailove/multi-model-router) | Route tasks to the optimal model across 3 providers and 6 cost tiers | [![Stars](https://img.shields.io/github/stars/Evgeniy-Mikhailove/multi-model-router?style=social)](https://github.com/Evgeniy-Mikhailove/multi-model-router) |
| [prompt-techniques-library](https://github.com/Evgeniy-Mikhailove/prompt-techniques-library) | Decision matrix for 6 prompting techniques: CoT, ReAct, Chaining, ToT, RAG | [![Stars](https://img.shields.io/github/stars/Evgeniy-Mikhailove/prompt-techniques-library?style=social)](https://github.com/Evgeniy-Mikhailove/prompt-techniques-library) |
...
| Project | What it does | |
|---------|-------------|---|
| [workflow-patterns](https://github.com/Evgeniy-Mikhailove/workflow-patterns) | 6 strategies for complex AI tasks: Fanout, Adversarial, Loop, Classify, Generate-Filter, Tournament | [![Stars](https://img.shields.io/github/stars/Evgeniy-Mikhailove/workflow-patterns?style=social)](https://github.com/Evgeniy-Mikhailove/workflow-patterns) |
| [loop-protocol](https://github.com/Evgeniy-Mikhailove/loop-protocol) | Self-correcting iteration loops. Score against rubric, fix weaknesses, repeat until convergence | [![Stars](https://img.shields.io/github/stars/Evgeniy-Mikhailove/loop-protocol?style=social)](https://github.com/Evgeniy-Mikhailove/loop-protocol) |
| [ai-text-humanizer](https://github.com/Evgeniy-Mikhailove/ai-text-humanizer) | 20 patterns that make AI text sound machine-generated. Checklist for removing AI traces | [![Stars](https://img.shields.io/github/stars/Evgeniy-Mikhailove/ai-text-humanizer?style=social)](https://github.com/Evgeniy-Mikhailove/ai-text-humanizer) |

### Sales & Automation

| Project | What it does | |
|---------|-------------|---|
| [incoming-intel](https://github.com/Evgeniy-Mikhailove/incoming-intel) | 7-step pipeline: process raw materials into working skills with adversarial critic | [![Stars](https://img.shields.io/github/stars/Evgeniy-Mikhailove/incoming-intel?style=social)](https://github.com/Evgeniy-Mikhailove/incoming-intel) |
| [zerocoder-sales-intake](https://github.com/Evgeniy-Mikhailove/zerocoder-sales-intake-skill) | AI sales intake - qualification, objection handling, CRM integration | [![Stars](https://img.shields.io/github/stars/Evgeniy-Mikhailove/zerocoder-sales-intake-skill?style=social)](https://github.com/Evgeniy-Mikhailove/zerocoder-sales-intake-skill) |
| [exosales-assistant](https://github.com/Evgeniy-Mikhailove/exosales-sales-assistant) | AI sales assistant for B2B outreach and follow-up automation | [![Stars](https://img.shields.io/github/stars/Evgeniy-Mikhailove/exosales-sales-assistant?style=social)](https://github.com/Evgeniy-Mikhailove/exosales-sales-assistant) |
